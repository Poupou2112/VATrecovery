...
class Client(Base):
    ...
    receipts = relationship("Receipt", back_populates="client", cascade="all, delete-orphan")
...
class User(Base):
    ...
    api_token = Column(String, unique=True, index=True, default=lambda: str(uuid.uuid4()))
    created_at = Column(DateTime, default=datetime.utcnow)
